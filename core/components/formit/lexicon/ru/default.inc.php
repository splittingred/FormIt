...
$_lang['formit.email_invalid'] = 'Пожалуйста, введите адрес электронной почты.';
...
$_lang['formit.email_tpl_nf'] = 'Пожалуйста, укажите шаблон адрес электронной почты.';
...
$_lang['formit.password_not_confirmed'] = 'Пожалуйста, подтвердите Ваш пароль.';
...
$_lang['formit.spam_blocked'] = 'Ваше сообщение было заблокированно спам фильтром: ';
$_lang['formit.spam_marked'] = ' - помеченно как спам.';
