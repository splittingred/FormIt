...
$_lang['prop_formit.customvalidators_desc'] = 'Eine kommaseparierte Liste von eigenen Validatoren (snippets), die auf das Formular angewandt werden sollen. Sie müssen hier explizit angegeben werden, um abzulaufen.';
